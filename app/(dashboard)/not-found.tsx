      ...
      <div className="max-w-md w-full border border-border rounded-sm bg-card p-6 space-y-4 text-center">
        ...
        <div className="space-y-1 text-xs">
          <h2 className="text-base font-semibold tracking-tight text-foreground">
            Resource or Case Docket Not Found
          </h2>
          <p className="text-muted-foreground">
            The requested case identification number, courtroom record, or administrative path does not exist in the judicial registry.
          </p>
        </div>
        ...
        <div className="pt-2">
          ...
          >
            ...
            Return to Administrative Portal
          </Link>
        </div>
      </div>
    </div>
